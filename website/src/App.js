            ...
            {hasHistory && (
              <div className="audit-timeline audit-timeline--streaming">
                {history.map((h, idx) => {
                  ...
                  return (
                    <div key={`audit-${idx}`} className={`audit-block audit-block--${verdict} audit-block--historical`}>
                    ...
                    {briefHistory.slice(0, -1).map((h, idx) => (
                      <div key={idx} className="brief-revision-block brief-revision-block--superseded">
                        <div className="brief-revision-header">
                          ...
                          <span className={`brief-revision-verdict verdict--${h.verdict || "unknown"}`}>
                            Audit: {(h.verdict || "unknown").toUpperCase()}
                          </span>
